...
import static com.example.robohonreception.voiceui.ScenarioDefinitions.TAG_ACCOST;
...
public class VoiceUIManagerUtil {
     ...
     *
     * @param vm {@link VoiceUIManager}
     * @param accost 実行するaccost名.
     *              {@code null}や空文字の場合は {@code VoiceUIManager.VOICEUI_ERROR} を返す.
     * @return updateAppInfoAndSpeechの実行結果
     * @see VoiceUIManager#updateAppInfoAndSpeech(List)
     */

...
class HVMLPlacement (private val hvmlModel: HvmlModel) {
    ...
    fun rotateArrowView() {
        mTreeSingleton.arrowRelations.forEach { arrowRelation ->
            val preLayout = arrowRelation.startView.findViewById(R.id.TopicName) as TextView
            val dstLayout = arrowRelation.targetView.findViewById(R.id.TopicName) as TextView

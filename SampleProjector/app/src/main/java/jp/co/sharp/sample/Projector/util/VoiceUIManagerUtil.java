package jp.co.sharp.sample.projector.util;
...
public class VoiceUIManagerUtil {
    ...
    static public int enableScene(VoiceUIManager vm, final String scene) {
        ...
        VoiceUIVariable variable = new VoiceUIVariable(jp.co.sharp.sample.projector.customize.ScenarioDefinitions.TAG_SCENE, VoiceUIVariable.VariableType.STRING);
